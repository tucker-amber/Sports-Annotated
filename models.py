...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("DB_STRING",'postgres://postgres:Hello!123@/postgres?host=/cloudsql/cs329e-idb-220319:us-central1:database-1')
